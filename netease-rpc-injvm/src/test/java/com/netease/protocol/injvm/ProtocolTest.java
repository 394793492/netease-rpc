...
public class ProtocolTest {
    ...
    URL url = URL.valueOf("injvm://localhost:0/com.netease.support.IEcho?interface=com.netease.support.IEcho");
    ...
    public void test_destroyWontCloseAllProtocol() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("of interface com.netease.Protocol is not adaptive method!"));
        }
