 ...
 */
package com.netease.protocol.rmi;
...
public class RmiProtocolTest {
    ...
    */
	...
	{
		DemoService service = new DemoServiceImpl();
		RpcUtils.export("demo://127.0.0.1:9030/com.netease.TestService",DemoService.class,service);
		RpcUtils.export("dubbo://127.0.0.1:9031/TestService",DemoService.class,service);
		RpcUtils.export("rmi://127.0.0.1:9032/com.netease.TestService",DemoService.class,service);
		RpcUtils.export("rmi://127.0.0.1:9033/com.netease.TestService",DemoService.class,service);

		service = RpcUtils.createProxy(DemoService.class,
				new String[]{
					"demo://127.0.0.1:9030/com.netease.TestService?weight=20",
					"dubbo://127.0.0.1:9031/TestService?weight=20",
					"rmi://127.0.0.1:9032/com.netease.TestService",
				});
		assertEquals(service.getSize(null), -1);
		assertEquals(service.getSize(new String[]{"","",""}), 3);
	...
	/*public void testForkInvoke() throws Exception
	{
		...
		protocol.export(proxy.createInvoker("rmi://127.0.0.1:9042/com.netease.TestService", DemoService.class, service);
		protocol.export(proxy.createInvoker("rmi://127.0.0.1:9043/com.netease.TestService", DemoService.class, service);
		...
		RpcInvokerGroup group = Proxies.createInvoker(DemoService.class, new String[]{
			...
			"rmi://127.0.0.1:9042/com.netease.TestService",
			"rmi://127.0.0.1:9043/com.netease.TestService",
		});
