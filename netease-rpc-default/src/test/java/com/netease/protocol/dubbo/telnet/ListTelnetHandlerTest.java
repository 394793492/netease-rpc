...
public class ListTelnetHandlerTest {
    ...
    public void testList() throws RemotingException {
        ...
        assertEquals("com.netease.protocol.dubbo.support.DemoService", result);
    ...
    public void testListDetail() throws RemotingException {
        ...
        assertEquals("com.netease.protocol.dubbo.support.DemoService -> dubbo://127.0.0.1:" + port + "/demo", result);
        EasyMock.reset(mockChannel);
    }
    ...
    public void testListDefault() throws RemotingException {
        ...
        DubboProtocol.getDubboProtocol().export(mockInvoker);
        String result = list.telnet(mockChannel, "");
        assertEquals("Use default service com.netease.protocol.dubbo.support.DemoService.\r\n\r\n"
                + methodsName, result);
        EasyMock.reset(mockChannel);
    }
