 ...
 */
package com.netease.protocol.dubbo.support;
...
import com.netease.service.GenericService;
...
//        reference.destroy();
    ...
    public void testGenricCustomArg() {
        ...
        Object obj = demoProxy.$invoke("get", new String[]{"com.netease.CustomArgument"}, new Object[]{arg});
        System.out.println("obj---------->" + obj);
        reference.destroy();
    }
