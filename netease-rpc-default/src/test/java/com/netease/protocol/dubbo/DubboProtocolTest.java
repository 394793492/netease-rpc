...
import com.netease.protocol.dubbo.support.NonSerialized;
import com.netease.protocol.dubbo.support.RemoteService;
import com.netease.protocol.dubbo.support.RemoteServiceImpl;
import com.netease.protocol.dubbo.support.Type;
...
public class DubboProtocolTest {
    ...
    public void testNonSerializedParameter() throws Exception {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage().contains("com.netease.protocol.dubbo.support.NonSerialized must implement java.io.Serializable"));
        }
    }
