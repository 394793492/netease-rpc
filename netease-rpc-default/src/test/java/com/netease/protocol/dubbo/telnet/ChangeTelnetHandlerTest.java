...
import com.netease.protocol.dubbo.support.ProtocolUtils;
...
public class ChangeTelnetHandlerTest {
    ...
    public void setUp() {
        ...
        EasyMock.expect(mockChannel.getAttribute("telnet.service")).andReturn("com.netease.protocol.dubbo.support.DemoService").anyTimes();
        mockChannel.setAttribute("telnet.service", "DemoService");
        EasyMock.expectLastCall().anyTimes();
        mockChannel.setAttribute("telnet.service", "com.netease.protocol.dubbo.support.DemoService");
        EasyMock.expectLastCall().anyTimes();
    ...
    public void testChangeName() throws RemotingException {
        DubboProtocol.getDubboProtocol().export(mockInvoker);
        String result = change.telnet(mockChannel, "com.netease.protocol.dubbo.support.DemoService");
        assertEquals("Used the com.netease.protocol.dubbo.support.DemoService as default.\r\nYou can cancel default service by command: cd /",
                result);
    }
    ...
    public void testChangeCancel() throws RemotingException {
        ...
        assertEquals("Cancelled default service com.netease.protocol.dubbo.support.DemoService.", result);
    }
